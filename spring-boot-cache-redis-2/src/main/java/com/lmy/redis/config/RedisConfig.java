package com.lmy.redis.config;

import com.alibaba.fastjson.parser.ParserConfig;
import com.fasterxml.jackson.annotation.JsonAutoDetect;
import com.fasterxml.jackson.annotation.PropertyAccessor;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.lmy.redis.cache.CacheTime;
import com.lmy.redis.cache.CustomizedRedisCacheManager;
import com.lmy.redis.serializer.FastJsonRedisSerializer;
import com.lmy.redis.serializer.StringRedisSerializer;
...
public class RedisConfig {
    ...
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        ...
        // 建议使用这种方式，小范围指定白名单
        ParserConfig.getGlobalInstance().addAccept("com.lmy.");
