...
import com.lmy.annotation.LogIgnore;
import com.lmy.annotation.LogTypeEnum;
import com.lmy.core.TrackLoggerFactory;
...
public class LogAspect {
    ...
    @Pointcut("@within(com.lmy.annotation.Log)")
    public void pointcutWithin() {
    }

    @Pointcut("@annotation(com.lmy.annotation.Log)")
