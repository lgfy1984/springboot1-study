package com.lmy.mybatis;

import com.lmy.BaseTest;
import com.lmy.domain.mapper.PersonMapper;
...
public class MybatisTest extends BaseTest {
    ...
    public void quickStartIBatis() throws Exception {
        ...
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            Person person = sqlSession.selectOne("com.lmy.domain.mapper.PersonMapper.selectByPrimaryKey", 1L);
            System.out.println(person.toString());
        }
    }
}
