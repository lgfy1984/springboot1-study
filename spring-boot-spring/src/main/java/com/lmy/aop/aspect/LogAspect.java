package com.lmy.aop.aspect;

import com.alibaba.fastjson.JSON;
import com.lmy.aop.annotations.Log;
...
public class LogAspect {
    ...
    // 切点
    @Pointcut("@annotation(com.lmy.aop.annotations.Log)")
    public void pointCutMethod() {
    }

    @Pointcut("@within(com.lmy.aop.annotations.Log)")
    public void pointCutType() {
    }

    // 建言
    @Before("pointCutMethod() || pointCutType()")
//    @Before("execution(* com.lmy.aop.controller.UserController.*(..))")
